...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
        <img src="https://play-lh.googleusercontent.com/nzy1nniRsoljcD5v4dsSVFQCcrGSrYDIu8yfKOC7CxaLNyVs3xk3a-HHWX4t0LiuS1KD" class="navbar-brand-img h-100" alt="...">
  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    ...
    <ul class="navbar-nav">
      <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link {{ (Request::is('communication') ? 'active' : '') }} " href="{{ url('communication') }}">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <span class="nav-link-text ms-1">Comunicação</span>
            </a>
        </li>
      <li class="nav-item">
