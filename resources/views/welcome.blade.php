                            ...
                            <div>
                                <div class="h-16 w-16 bg-red-50 dark:bg-gray-900 flex items-center justify-center rounded-full">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="w-7 h-7 stroke-red-500">
                                        <img src="https://www.ccbeuguarapuava.com.br/wp-content/uploads/2021/05/2.png" alt="profile_image" class="w-100 border-radius-lg shadow-sm">
                                    </svg>
                                </div>
